...
class TwitterSettingsRestTest {
  ...
  void deleteTwitterBearerTokenAnonymously() throws Exception {
    ResultActions response = mockMvc.perform(delete(REST_PATH).contentType(MediaType.APPLICATION_JSON)
                                                              .accept(MediaType.APPLICATION_JSON));
    response.andExpect(status().isForbidden());
  }
  ...
  void deleteTwitterBearerTokenAdmin() throws Exception {
    ...
    response = mockMvc.perform(delete(REST_PATH).with(testAdminUser())
                                                .contentType(MediaType.APPLICATION_JSON)
                                                .accept(MediaType.APPLICATION_JSON));
